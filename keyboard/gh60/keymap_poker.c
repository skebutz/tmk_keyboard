...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP(ESC,    1,   2,   3,   4,   5,   6,   7,   8,   9,   0,MINS,DELETE,HOME, END,PGDN,PGUP, \
           ...
           LCTL,LALT, FN0, ENT,BSPC, SPC,COMM, DOT, FN1,RALT,RCTL,LEFT,  RGHT,PENT,  P0,PDOT,PPLS),
           
    /* 1: Cat */   
    KEYMAP(PWR,   F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9, F10, F11,   F12,PSCR,PAUS,NLCK,SLCK, \
           NO,    NO,  NO,  NO,  NO,  NO,  NO,ACL2,  NO,MS_U,BTN2, GRV,  RBRC,  NO,  NO,  NO,  NO, \
           CAPS,VOLD,VOLU,MUTE,  NO,  NO,  NO,ACL1,MS_L,MS_D,MS_R, FN3,    NO,  NO,  NO,  NO,  NO, \
...
const uint16_t PROGMEM fn_actions[] = {
  ...
  [1] = ACTION_LAYER_TAP(2, KC_ENT),
  [2] = ACTION_MODS_KEY(MOD_LSFT, KC_1)
  [3] = ACTION_MODS_KEY(MOD_LSFT, KC_MINS)
};
